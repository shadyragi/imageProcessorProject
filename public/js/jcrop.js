    ...
    (a.Jcrop = function (b, c) {
                ...
                u = (function () {
                    return function () {
                        (q += (100 - q) / r),
                            ...
                            q >= 99.8 && (q = 100),
                            q < 100 ? (bh(k), t()) : (bb.done(), bb.animMode(!1), typeof b == "function" && b.call(bs));
                    };
                })();
            t();
        }
        ...
        function br(a) {
            d.allowResize ? (a ? bb.enableOnly() : bb.enableHandles()) : bb.disableHandles(),
                ...
                ba.refresh(),
                d.bgColor != N && (bq(d.shade ? ba.getShades() : G, d.shade ? d.shadeColor || d.bgColor : d.bgColor), (N = d.bgColor)),
            ...
            _ = (function () {
                ...
                function m() {
                    ...
                    return (
                        ...
                        i === 0 && (i = F * 10),
                        n < f
                            ? ((s = e), (t = m * f), (r = j < 0 ? a - t : t + a), r < 0 ? ((r = 0), (u = Math.abs((r - a) / f)), (s = k < 0 ? b - u : u + b)) : r > E && ((r = E), (u = Math.abs((r - a) / f)), (s = k < 0 ? b - u : u + b)))
                            : ((r = c), (u = l / f), (s = k < 0 ? b - u : b + u), s < 0 ? ((s = 0), (t = Math.abs((s - b) * f)), (r = j < 0 ? a - t : t + a)) : s > F && ((s = F), (t = Math.abs(s - b) * f), (r = j < 0 ? a - t : t + a))),
                        r > a
                            ? (r - a < g ? (r = a + g) : r - a > h && (r = a + h), s > b ? (s = b + (r - a) / f) : (s = b - (r - a) / f))
                            : r < a && (a - r < g ? (r = a - g) : a - r > h && (r = a - h), s > b ? (s = b + (a - r) / f) : (s = b - (a - r) / f)),
